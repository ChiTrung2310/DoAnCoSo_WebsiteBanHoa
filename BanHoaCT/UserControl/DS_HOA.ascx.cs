...
public partial class UserControl_DS_HOA : System.Web.UI.UserControl
{
    ...
    {
        string cau_lenh = "SELECT Ms,Ten_hoa,Mo_ta,Hinh_minh_hoa,Don_gia FROM HOA";
    ...
    {
        //hienthi();//---Hiển thị số trang ngay dưới phần thanh số trang và hạn chế lỗi khi bấm vào trang đầu cuối!!!
        ...
        if (!IsPostBack)
        {
            ...
            {
                dlHoa.DataSource = XL_DuLieu.Doc_bang("select top 12 * from HOA order by ngay_cap_nhat desc");
    ...
    protected void txttrang_Load(object sender, EventArgs e)
    {
       
    }

    protected void dlHoa_Load(object sender, EventArgs e)
    {
