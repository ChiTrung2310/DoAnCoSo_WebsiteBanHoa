...
public partial class UserControl_DS_HOA : System.Web.UI.UserControl
{
    ...
    {
        string cau_lenh = "SELECT Ms,Ten_hoa,Mo_ta,Hinh_minh_hoa,Don_gia FROM HOA where Ten_hoa like N'%Bó%'";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
         ...
         if (Request.QueryString["tenhoa"] != null)
            ...
            {
                dlHoa.DataSource = XL_DuLieu.Doc_bang("select * from HOA where Ten_hoa like N'%Bó%'");
