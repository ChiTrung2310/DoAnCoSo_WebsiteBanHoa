...
{
    public static String chuoi_ket_noi = @"Server = LAPTOP-G0I3AISP; Database = QL_BANHOA_CT ; Integrated Security = SSPI";
    ...
    public static DataTable Tao_gio_hang()
    {
        ...
        gio_hang.Columns.Add("Ten_hoa", typeof(string));
    ...
    {
        // Gmail của Admin 
        var fromAddress = "phanchitrung231020@gmail.com"; //Edit

        //Password Gmail của Admin
        const string fromPassword = "123456abC";  //Edit
